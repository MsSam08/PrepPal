...
**This document defines EXACT contracts between ML API and other systems. Following these specs prevents crashes. NOTE: It is meant to give a fair idea on how to integrate the model, not a replacement to your actual code.**
---
